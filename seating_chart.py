...
def generate_reportlab_from_data(seating_layout, students, output_pdf):
    ...
    # macOS 系統字體
    mac_font_paths = [
        ('PingFangTC', '/System/Library/Fonts/PingFang.ttc'),
        ('STHeiti', '/System/Library/Fonts/STHeiti.ttc'),
    ]
    
    # 尝試載入字體
    all_fonts = font_paths + linux_font_paths + mac_font_paths
    ...
    if font_name is None:
        ...
        print("请安装中文字体，例如：sudo apt-get install fonts-noto-cjk")
        font_name = 'Helvetica'
